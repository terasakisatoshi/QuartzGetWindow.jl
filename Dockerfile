...
ENV JULIA_PROJECT "@."
WORKDIR /workspace/QuartzGetWindow.jl

USER root
RUN chown -R ${NB_UID} /workspace/QuartzGetWindow.jl
USER ${USER}

RUN mkdir -p /workspace/QuartzGetWindow.jl/src && echo "module QuartzGetWindow end" > /workspace/QuartzGetWindow.jl/src/QuartzGetWindow.jl
COPY ./Project.toml /workspace/QuartzGetWindow.jl
